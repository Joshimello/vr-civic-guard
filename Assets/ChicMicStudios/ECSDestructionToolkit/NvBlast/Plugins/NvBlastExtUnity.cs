...
namespace Frimus
{
    namespace ECSDestructionToolkit
    {
        ...
        public class NvMesh : DisposablePtr
        {
            ...
            private static extern void _Mesh_Relase(IntPtr mesh);
            ...
            protected override void Release()
            {
                try
                {
                    _Mesh_Relase(this.ptr);
                    NvLogger.Log("_Mesh_Release Non Commented Dispose Mesh");
                }
                catch (Exception ex)
                {
                    NvLogger.LogWarning("_Mesh_Release Commented Dispose Mesh" + ex.Message);
                }
            }
        ...
        public class NvMeshCleaner : DisposablePtr
        {
            ...
            protected override void Release()
            {
                try
                {
                    ...
                    NvLogger.Log("_Cleaner_Release Non Commented Dispose Nv Mesh Cleaner");
                }
                catch (Exception ex)
                {

                    NvLogger.LogWarning("_Cleaner_Release Non Dispose Nv Mesh Cleaner. " + ex.Message);
                }
            }
        }
        ...
        public class NvFractureTool : DisposablePtr
        {
            ...
            protected override void Release()
            {
                try
                {
                    ...
                    NvLogger.Log("_FractureTool_Release Non Commented Dispose Fracture Tool.");
                }
                catch (Exception ex)
                {
                    NvLogger.LogWarning("_FractureTool_Release Commented Dispose Fracture Tool. " + ex.Message);
                }
            }
        }
        ...
        {
            [DllImport("NvBlastExtUnity_x64")]
            private static extern void _NvVoronoiSitesGenerator_Release(IntPtr site);
            ...
            protected override void Release()
            {
                try
                {
                    _NvVoronoiSitesGenerator_Release(this.ptr);
                    NvLogger.Log("_VoronoiSitesGenerator_Release Non Commented Dispose Voronoi Sites Generator.");
                }
                catch (Exception ex)
                {
                    NvLogger.LogWarning("_VoronoiSitesGenerator_Release Commented Dispose Voronoi Sites Generator. " + ex.Message);
                }
            }
